...
namespace RE4_GCWII_BIN_TOOL.REPACK
{
    ...
    {
        public static void RepackSMD(Stream smdFile, bool CompressVertices, out IntermediaryStructure intermediaryStructure, out FinalBoneLine[] bones, ref float FarthestVertex)
        {
            ...
            bones = GetBoneLines(smd, Endianness.BigEndian);
        }
