...
namespace RE4_GCWII_BIN_TOOL.REPACK
{
    ...
    {
        public static void RepackOBJ(Stream objFile, bool CompressVertices, int ObjFileUseBone, out IntermediaryStructure intermediaryStructure, bool UseColors, ref float FarthestVertex)
        {
            // load .obj file
